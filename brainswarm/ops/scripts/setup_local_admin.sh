...
sudo cp ../systemd/local-admin.service /etc/systemd/system/
...
echo "export BRAIN_SWARM_BASE_URL=http://localhost:8000"
echo "export BRAIN_SWARM_API_KEY=your-api-key-here  # Optional"
echo "python app.py"