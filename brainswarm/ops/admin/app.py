...
# Prometheus metrics
REQUEST_COUNT = Counter('admin_requests_total', 'Total number of requests', ['method', 'endpoint', 'status'], registry=registry)
RESPONSE_TIME = Histogram('admin_request_duration_seconds', 'Request duration in seconds', ['method', 'endpoint'], registry=registry)
ACTIVE_USERS = Gauge('admin_active_users', 'Number of currently active users', registry=registry)
LOGIN_ATTEMPTS = Counter('admin_login_attempts_total', 'Total login attempts', ['result'], registry=registry)
SYSTEM_CPU = Gauge('admin_system_cpu_percent', 'System CPU usage percentage', registry=registry)
SYSTEM_MEMORY = Gauge('admin_system_memory_percent', 'System memory usage percentage', registry=registry)
SYSTEM_DISK = Gauge('admin_system_disk_percent', 'System disk usage percentage', registry=registry)
HEALTH_CHECKS = Counter('admin_health_checks_total', 'Total health checks performed', ['service', 'status'], registry=registry)
...
# Prometheus metrics
cpu_g = Gauge("system_cpu_usage", "CPU usage percentage", registry=registry)
mem_g = Gauge("system_mem_usage", "Memory usage percentage", registry=registry)
disk_g = Gauge("system_disk_usage", "Disk usage percentage", registry=registry)
