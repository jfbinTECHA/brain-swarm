...
# Import gym or provide lightweight stubs if unavailable
try:
...
try:
    ...
    RL_AVAILABLE = False
    # Provide light-weight fallbacks for typing without importing numpy at module import
    class _NPStub:
        float32 = None
        @staticmethod
    ...
    try:
        ...
        class LogisticRegression:  # type: ignore
            ...
            def fit(self, X, y):  # type: ignore
                return self
    logger.log("WARNING", "AdaptiveTaskBroker", "RL deps not available; using basic methods without numpy")
